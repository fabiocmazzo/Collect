...
public class FormEntryActivity extends Activity implements AnimationListener,
    ...
    private void createConstraintToast(FormIndex index, int saveStatus) {
        ...
        String nomedoCampo	= formController.getQuestionPrompt(index).getQuestionText();
        String tipo = formController.getQuestionPrompt(index).getAppearanceHint();
        switch (saveStatus) {
            ...
            case FormEntryController.ANSWER_REQUIRED_BUT_EMPTY:
                ...
                if (tipo != null && tipo.equals("cpf")) {
                 constraintText = nomedoCampo + " - " + "CPF Inválido";
                } else {
                 constraintText = nomedoCampo + " - " + getString(R.string.required_answer_error);
                }
                 break;
        }
